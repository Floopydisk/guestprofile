<?php
// Database credentials (replace with actual details)
...
// Old way of creating connection
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $lga = $_POST["lga"];
  $city = isset($_POST["city"]) ? $_POST["city"] : ""; // City is optional in HTML
  $state = $_POST["state"];
  $zip = isset($_POST["zip"]) ? $_POST["zip"] : "";   // Zip is optional in HTML
